...
export class ChatInputCommand implements Command {
    ...
    public execute: (interaction: ChatInputCommandInteraction) => Promise<ReturnableInteraction | void> | ReturnableInteraction;
    ...
    public setExecute(execute: (interaction: ChatInputCommandInteraction) => Promise<ReturnableInteraction | void> | ReturnableInteraction) {
...
export class ContextMenuCommand implements Command {
    ...
    public execute: (interaction: ContextMenuCommandInteraction) => Promise<ReturnableInteraction | void> | ReturnableInteraction;
    ...
    public setExecute(execute: (interaction: ContextMenuCommandInteraction) => Promise<ReturnableInteraction | void> | ReturnableInteraction) {
        this.execute = execute;
        return this;
    }
}
